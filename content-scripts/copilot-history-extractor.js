...
(function() {
  ...
  // TODO: Update this selector after inspecting Copilot's DOM
  // This is used for language detection and positioning the save button
  ...
  function init() {
    ...
    // TODO: Update URL pattern check after confirming conversation URL structure
    // Check for both copilot.microsoft.com and bing.com/chat
  ...
  function createSaveButton() {
    ...
    // TODO: Update button classes to match Copilot's UI styling after inspection
  ...
  function insertSaveButton() {
    ...
    // TODO: Update share button selector after DOM inspection
  ...
  function getConversationTitle() {
    // TODO: Update title selectors after inspecting Copilot's DOM
    // Try various selectors that might contain the conversation title
  ...
  function getMessages() {
    ...
    // TODO: Update message container selectors after inspecting Copilot's DOM
  ...
  function extractMessageFromContainer(container) {
    // TODO: Update role detection after inspecting Copilot's DOM
    ...
    if (roleAttr) {
      role = roleAttr.toLowerCase().includes('user') ? 'user' : 'assistant';
    } else {
      // Try to detect based on classes
      const classes = container.className.toLowerCase();
      if (classes.includes('user')) {
        role = 'user';
      } else if (classes.includes('assistant') || classes.includes('bot') || classes.includes('copilot')) {
        role = 'assistant';
      }
    }

    // TODO: Update content element selectors after DOM inspection
    // Get message content
